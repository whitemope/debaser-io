# Debaser — Features Page Content (Option 1)
...
**Feature nav pills:** 01 Ingestion · 02 Matching · 03 Contract Intelligence · 04 Anomaly Detection · 05 Explainability · 06 Missing Income
...
**Demo:** Statement Ingestion · Q2 2024 — three files (Spotify CSV, MCPS PDF, Apple Music XLSX) normalised into 4,463 rows against a unified schema.
...
**Demo:** Catalogue Matching · Atlantic Records UK — 5 recordings processed: 3 matched, 1 partial, 1 unmatched.
...
**Demo:** Contract Intelligence · License Agreement — extracts royalty rate (18% of net receipts), territory, recoupment and producer deduction terms from contract text.
...
**Demo:** Anomaly Detection · Q2 2024 Royalty Run — £8,964 total income, 4 statements processed, 3 anomalies flagged (DE Apple Music drop, FR SACEM duplicate, early producer deduction).
...
**Demo:** Explainability · Royalty Q&A — "Why did Spotify UK income drop this quarter?" answered with a source-cited explanation.
...
**Demo:** Missing Income Detection · All Rights · Q2 2024 — £4,960 total missing income across 5 rights/sources (2 critical, 1 high, 1 low).

---

## CTA

**Headline:** Ready to see it on your catalogue?

**Subhead:** Send us last quarter's royalty mess. We'll show you what's wrong.

**CTAs:**
- Request early access (primary, links to /#access)
- Back to overview (secondary, links to /)
